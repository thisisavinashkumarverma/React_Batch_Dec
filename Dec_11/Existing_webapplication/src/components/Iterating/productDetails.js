        ...
        <div className='parent'>
            {
                productDetails.map((productData, index) => (
                    <ul key={index}>
                        ...
                        <li>Title - {productData.title}</li>
                        <li>
                            Price - {productData.price} &nbsp;&nbsp;                            
                        </li>
                        <li>Description - {productData.description}</li>
                        <li>Category - {productData.category}</li>
                        <li>Rating - {productData.rating.rate} ({productData.rating.count})</li>
                        <li>
                            {
                                isFeepaid ? <span className='fee-paid'> Fee Paid </span> : <span className='fee-pending'> Fee Pending </span>
                            }
                        </li>
                    </ul>
                ))
